...
def test_unified_win_predictor_team_compare_architecture_output_shape():
    model = UnifiedWinPredictorModel(
        num_champions=7,
        dense_feature_dim=22,
        num_player_features=2,
...
def test_unified_win_predictor_pairwise_architecture_output_shape():
    model = UnifiedWinPredictorModel(
        num_champions=7,
        dense_feature_dim=22,
        num_player_features=2,
...
def test_unified_win_predictor_cls_global_architecture_output_shape():
    model = UnifiedWinPredictorModel(
        num_champions=7,
        dense_feature_dim=22,
        num_player_features=2,
